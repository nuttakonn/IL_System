...
namespace EB_Service.Commons
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        //public const string DefaultThemeName = "Youthful";
        public string DefaultThemeName = ConfigurationManager.AppSettings["ThemeName"].Trim() != "" ? ConfigurationManager.AppSettings["ThemeName"].Trim() : "DevEx";
        ...
        //        return (UnboundSiteMapProvider)Session["DemoUnboundProvider"];
        //    }
        //}
        //public bool IsSiteMapCreated { get { return Session["DemoUnboundProvider"] != null; } }

        protected string GetThemeCookieName()
        {
            string cookieName = "DemoCurrentThemeNew";
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            // Scripts
            RegisterScript("Utilities", "~/Js/Utilities.js");
            // CSS
        ...
        private void TooltipDropDown()
        {
            ...
            foreach (Control control in allControls)
            {
                ...
                {
                    dropDownList.Attributes.Add("onMouseOver", "ShowTooltipDropdownList(this)");
                }
            }
        }
        /* Functions */
