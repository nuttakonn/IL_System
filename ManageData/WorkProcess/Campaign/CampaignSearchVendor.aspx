<%@ Page Title="" Language="C#" MasterPageFile="~/ManageData/MasterSite/CSManageMasterSiteMain_BlankSite.Master" AutoEventWireup="true" CodeBehind="CampaignSearchVendor.aspx.cs" Inherits="ILSystem.ManageData.WorkProcess.Campaign.CampaignSearchVendor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="phContents" runat="Server">
   ...
   <%-- <script type="text/javascript" src="../../../Css/_Styles.css"></script>--%>
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:GridView ID="gv_listVendor" runat="server" ShowHeaderWhenEmpty="true" EmptyDataText="No records found" AutoGenerateColumns="false" Width="100%"
                                                            AllowPaging="true" PageSize="20" CellPadding="4" OnPageIndexChanging="gv_listVendor_PageIndexChanging">                                                  
                                                            <Columns>
                                                    ...
                                                    <fieldset style="border-radius: 5px;">
                                                        ...
                                                        <asp:Panel runat="server" ID="box_branch_filter">
                                                            <table width="100%">
                                                                <tr valign="middle">
                                                                    <%--<td>
                                                                        <asp:RadioButton ID="rdbAllBranch" runat="server" Text="" GroupName="[GroupBranch]"></asp:RadioButton><p style="display: inline-block;">All Branch</p>


                                                                    </td>
                                                                    <td>
                                                                        <asp:RadioButton ID="rdbAllMybranch" runat="server" Text="" GroupName="[GroupBranch]"></asp:RadioButton><p style="display: inline-block; margin-bottom: 10px;">My Branch</p>

                                                                    </td>--%>
                                                                    <td align="center" width="150px">

                                                                        <dx:ASPxButton ID="btnMainSearch" OnClick="CLICK_MAIN_SEARCH" runat="server" Text="Find Vendor" Height="25" Width="120" CssClass="imgNormal2" Cursor="pointer">
                                                                    ...
                                                                    <td align="center" width="150px">
                                                                        ...
                                                                        <dx:ASPxButton ID="btnMainDetail" ClientInstanceName="btnMainDetail" ClientEnabled="true" OnClick="CLICK_MAIN_DETAIL" runat="server" Text="Select Vendor" Height="25" Width="120" CssClass="imgNormal2" Cursor="pointer">
                                                            ...
                                                            <asp:HiddenField ID="dt_Popup_Vendorlistselected" runat="server" />
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left; font-family: Tahoma; font-size: small; width: 200px; height: 24px;"
                                                    ...
                                                    <asp:Button ID="searchCampaignPopup" runat="server" Text="Search" Width="80px" Height="24px" OnClick="CLICK_SEARCH_CAMPAIGN_POPUP"
                                                        BackColor="#66CCFF" />&nbsp;&nbsp;
                                                    <asp:Button ID="Button12" runat="server" Text="Clear" Width="80px" Height="24px" BackColor="#66CCFF" OnClick="CLEAR_POPUP_CAMPAIGN" />
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <dx:PopupControlContentControl ID="PopupControlContentControl8" runat="server" SupportsDisabledAttribute="True">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td style="text-align: left; font-family: Tahoma; font-size: small; width: 200px; height: 24px;"
                                                    colspan="2">
                                                    <asp:Button ID="Button6" runat="server" Text="Search" Width="80px" Height="24px" OnClick="CLICK_SEARCH_PRODUCT_TYPE_POPUP"
                                                        BackColor="#66CCFF" />&nbsp;&nbsp;
                                                    <asp:Button ID="Button7" runat="server" Text="Clear" Width="80px" Height="24px" BackColor="#66CCFF" OnClick="CLEAR_POPUP_PRODUCTTYPE" />
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <dx:PopupControlContentControl ID="PopupControlContentControl9" runat="server" SupportsDisabledAttribute="True">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td style="text-align: left; font-family: Tahoma; font-size: small; width: 200px; height: 24px;"
                                                    colspan="2">
                                                    <asp:Button ID="Button3" runat="server" Text="Search" Width="80px" Height="24px" OnClick="CLICK_SEARCH_PRODUCT_CODE"
                                                        BackColor="#66CCFF" />&nbsp;&nbsp;
                                                    <asp:Button ID="Button8" runat="server" Text="Clear" Width="80px" Height="24px" BackColor="#66CCFF" OnClick="CLEAR_POPUP_PRODUCTCODE" />
                                                </td>
                                            </tr>
                                        </table>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left; font-family: Tahoma; font-size: small; width: 200px; height: 24px;"
                                                    ...
                                                    <asp:Button ID="searchingBrand" runat="server" Text="Search" Width="80px" Height="24px" OnClick="CLICK_SEARCH_BRAND_POPUP"
                                                        BackColor="#66CCFF" />&nbsp;&nbsp;
                                                    <asp:Button ID="Button2" runat="server" Text="Clear" Width="80px" Height="24px" BackColor="#66CCFF" OnClick="CLEAR_POPUP_BRAND" />
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <dx:PopupControlContentControl ID="PopupControlContentControl2" runat="server" SupportsDisabledAttribute="True">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td style="text-align: left; font-family: Tahoma; font-size: small; width: 200px; height: 24px;"
                                                    colspan="2">
                                                    <asp:Button ID="Button1" runat="server" Text="Search" Width="80px" Height="24px" OnClick="CLICK_SEARCH_MODEL_POPUP"
                                                        BackColor="#66CCFF" />&nbsp;&nbsp;
                                                    <asp:Button ID="Button4" runat="server" Text="Clear" Width="80px" Height="24px" BackColor="#66CCFF" OnClick="CLEAR_POPUP_MODEL" />
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <dx:PopupControlContentControl ID="PopupControlContentControl4" runat="server" SupportsDisabledAttribute="True">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td style="text-align: left; font-family: Tahoma; font-size: small; width: 200px; height: 24px;"
                                                    colspan="2">
                                                    <asp:Button ID="Button9" runat="server" Text="Search" Width="80px" Height="24px" OnClick="CLICK_SEARCH_PRODUCT_ITEM_POPUP"
                                                        BackColor="#66CCFF" />&nbsp;&nbsp;
                                                    <asp:Button ID="Button10" runat="server" Text="Clear" Width="80px" Height="24px" BackColor="#66CCFF" OnClick="CLEAR_POPUP_PRODUCT_ITEM" />
                                                </td>
                                            </tr>
                                        </table>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left; font-family: Tahoma; font-size: small; width: 200px; height: 24px;"
                                                    ...
                                                    <asp:Button ID="Popup_searchVendor" runat="server" Text="Search" Width="80px" Height="24px" OnClick="CLICK_SEARCH_VENDOR_POPUP"
                                                        BackColor="#66CCFF" />&nbsp;&nbsp;
                                                    <asp:Button ID="Button5" runat="server" Text="Clear" Width="80px" Height="24px" BackColor="#66CCFF" OnClick="CLEAR_POPUP_VENDOR" />
                                                </td>
                                            </tr>
                                        </table>
