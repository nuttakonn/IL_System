<%@ Page Title="" Language="C#" MasterPageFile="~/ManageData/MasterSite/CSManageMasterSiteMain_BlankSite.Master" AutoEventWireup="true" CodeBehind="CampaignSearchProduct.aspx.cs" Inherits="ILSystem.ManageData.WorkProcess.Campaign.CampaignSearchProduct" %>
                        ...
                        <dx:PanelContent ID="PanelContent1" runat="server" SupportsDisabledAttribute="True">
                            ...
                            <table width="100%">
                                <tr valign="top">
                                    ...
                                    <td width="40%" rowspan="2"><%--<td width="480px">--%>
                                ...
                                <tr>
                                    <td valign="top">
                                        <table style="margin-top: 1px;">
                                            <tr align="left">
                                                <td>
                                                    <asp:Label ID="Label28" runat="server" Text=" Selected product list" Style="font-weight: bold; font-size: 14px; margin-top: 3px;"></asp:Label>
                                                ...
                                                <tr>
                                                    <td valign="top" align="left">
                                                        <asp:GridView ID="gv_listSelected" runat="server" ShowHeaderWhenEmpty="true" EmptyDataText="No records found" AutoGenerateColumns="false" Width="100%"
                                                            ...
                                                            <%-- <asp:GridView ID="gv_listSelected" runat="server" ShowHeaderWhenEmpty="true" ForeColor="#333333" EmptyDataText="No records found" AutoGenerateColumns="false" Width="100%"
                                                            AllowPaging="true" PageSize="8" OnPageIndexChanging="gv_listSelected_PageIndexChanging" OnRowDeleting="gv_listSelected_RowDeleting">                                     --%>
                                                            ...
                                                            <%--   <SelectedRowStyle BackColor="#C9FECC" Font-Bold="True" ForeColor="Navy" />--%>
                                                        </asp:GridView>
                                                    </td>
                                                </tr>
