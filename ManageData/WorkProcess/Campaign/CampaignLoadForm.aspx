<%@ Page Title="" Language="C#" MasterPageFile="~/ManageData/MasterSite/CSManageMasterSiteMain_BlankSite.Master" AutoEventWireup="true" CodeBehind="CampaignLoadForm.aspx.cs" Inherits="ILSystem.ManageData.WorkProcess.Campaign.CampaignLoadForm" %>
                            ...
                            <table width="100%">
                                <tr valign="top">
                                    <td width="40%" align="center">
                                        ...
                                        <div style="box-shadow: 2px 2px #AAAAAA; width: 530px; height: 850px; overflow-x: auto; overflow-y: auto; background-color: #F1F1F1; margin-top: 5px;">
                                            <div>
                                                            ...
                                                            <table width="100%">
                                                                <tr valign="middle">
                                                                    ...
                                                                    <td align="center" width="150px">
                                                                        ...
                                                                        <dx:ASPxButton ID="btnMainSearch" OnClick="CLICK_MAIN_SEARCH" runat="server" Text="Find Campaign" Height="25" Width="120" CssClass="imgNormal4" Cursor="pointer">
                                                                    ...
                                                                    <td align="center" width="150px">
                                                                        ...
                                                                        <dx:ASPxButton ID="btnMainDetail" OnClick="CLICK_MAIN_DETAIL" runat="server" Text="View All Detail" Height="25" Width="120" CssClass="imgNormal4" Cursor="pointer">
                                                    ...
                                                    <td>
                                                        <fieldset style="border-radius: 5px; background-color: #eff4f9;">
                                                            ...
                                                            <table width="100%" style="align-content: center">
                                                                <tr valign="middle">
                                                                    <td align="left">
                                                                        <div id="dataListSelected" style="width: 500px; height: 120px; background-color: #FFFFFF; overflow-y: scroll"></div>
