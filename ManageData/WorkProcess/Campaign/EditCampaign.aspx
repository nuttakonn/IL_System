<%@ Page Title="" Language="C#" MasterPageFile="~/ManageData/MasterSite/ChgManage_BlankSite.Master" AutoEventWireup="true" CodeBehind="EditCampaign.aspx.cs" Inherits="ILSystem.ManageData.WorkProcess.Campaign.EditCampaign" %>
                                                            ...
                                                            <table width="100%" border="0">
                                                                <tr valign="middle">
                                                                    ...
                                                                    <td align="center" width="150px">
                                                                        ...
                                                                        <dx:ASPxButton ID="btnMainDetail" OnClick="CLICK_MAIN_DETAIL" runat="server" Text="View All Detail" Width="130" Height="25" CssClass="imgNormal2" Cursor="pointer">
